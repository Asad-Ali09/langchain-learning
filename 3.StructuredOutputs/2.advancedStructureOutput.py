...
class Review(TypedDict):
    key_themes: Annotated[list[str], "must write down all the important concepts mentioned in the review"]
    summary: Annotated[str, "a concise summary of the review in one sentence"]
    sentiment: Annotated[str, "overall sentiment of the review, can be positive, negative or neutral"]
